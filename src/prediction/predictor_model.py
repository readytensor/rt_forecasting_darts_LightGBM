        ...
        **kwargs,
        ...
        Args:
            ...
            likelihood (Optional[str]):
                ...
                When set to 'gaussian', the model will use LightGBM's 'RMSEWithUncertainty' loss function.
                When using this loss function, LightGBM returns a mean and variance couple, which capture data (aleatoric) uncertainty.
